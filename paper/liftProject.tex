...
\DONa{
	...
	2. Transformeer alle standaard deviaties naar varianties direct na het samplen en sla dat op.
	3. Schoon de code op wat betreft het transformeren van varianties.
}
...
\begin{figure}[!ht]
	\includegraphics[width=\textwidth]{descriptivesProduct.pdf}
